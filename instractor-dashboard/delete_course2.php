 ...
 *
 * This script allows an instructor to delete a course and its associated content.
 * It verifies the instructor's ownership of the course before deletion.
 *
 * PHP version 8.0+
 *
...
if (isset($_POST['course_id'])) {
    ...
    /**
     * Step 1: Fetch the instructor ID associated with the logged-in user
     */
    ...
    // If no instructor record is found
    if (!$instructor) {
    ...
    /**
     * Step 2: Verify that the course belongs to the current instructor
     */
    ...
    // If the course doesn't belong to the instructor
    ...
    /**
     * Step 3: Delete all related content from Course_Content table
     */
    ...
    /**
     * Step 4: Delete the course from Course table
     */
    ...
    /**
     * Step 5: Check deletion result and redirect
     */
